...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HTTPServer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HTTPServer_t qt_meta_stringdata_HTTPServer = {
    {
QT_MOC_LITERAL(0, 0, 10), // "HTTPServer"
QT_MOC_LITERAL(1, 11, 21), // "slt_ConnectionHandler"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "HTTPServer\0slt_ConnectionHandler\0"
};
...
void HTTPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->slt_ConnectionHandler(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *HTTPServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HTTPServer.stringdata))
